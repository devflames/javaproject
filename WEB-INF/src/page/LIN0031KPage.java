...
public class LIN0031KPage extends BasePage {
		...
		try {
			...
			// 登録・下書保存
				...
				// 下書保存
					...
					int temp_id = (int)this.sqlMap.insert("addLineTemp",paraMap);

					//this.REDIRECT_URL = "!LIN0040!";
					//this.setPath("REDIRECT.htm");
					temp = new LineTempJSON();
					temp.setTemp_id(temp_id);
